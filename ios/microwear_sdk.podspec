...
# Run `pod lib lint microwear_sdk.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'microwear_sdk'
  s.version          = '0.0.1'
...
#   'FR/SpotifyiOS.xcframework'
  ...
  # s.resource_bundles = {'microwear_sdk_privacy' => ['Resources/PrivacyInfo.xcprivacy']}
end
